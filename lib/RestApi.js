...
var NorenRestApi = function (params) {
  ...
  self.login = function (params) {
    ...
    console.log("authParams in login Restapi >>>>>>>>>>>", authparams);
    console.log("Params in login Restapi >>>>>>>>>>>", params);
  ...
  self.get_option_chain = function (
    ...
    values["tsym"] = tsym;
    values["strprc"] = strprc;
    values["cnt"] = "8";
    values["uid"] = self.__username;
    let reply = post_request("optionchain", values);
    return reply;
  };
